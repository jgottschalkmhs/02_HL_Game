...
print("\nWelcome to HL game, by Aref Osman. The game will generate a secret number\n"
      ...
      "'too low' or 'too high'. A set algorithm will determine the number of guesses that\n"
      "you will be allowed to use per round.")
print()
...
while keep_going == "":
    ...
    # How many rounds?
    rounds = intcheck("How many rounds do you want to play? ", 1, 25)
